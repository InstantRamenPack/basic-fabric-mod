...
public class SquirrelAnimations {
    public static final AnimationDefinition IDLING = AnimationDefinition.Builder.create(1.0F).looping()
            ...
            .addBoneAnimation("bb_main", new Transformation(Transformation.Targets.MOVE_ORIGIN,
                    new Keyframe(0.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
                    new Keyframe(0.5F, AnimationHelper.createTranslationalVector(0.0F, -0.42F, 0.0F), Transformation.Interpolations.LINEAR),
                    new Keyframe(1.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR)
            ))
            .build();
    ...
    public static final AnimationDefinition WALKING = AnimationDefinition.Builder.create(0.5F).looping()
            ...
            .addBoneAnimation("bb_main", new Transformation(Transformation.Targets.MOVE_ORIGIN,
                    new Keyframe(0.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
                    new Keyframe(0.0833F, AnimationHelper.createTranslationalVector(0.0F, 1.34F, 0.0F), Transformation.Interpolations.LINEAR),
